...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            if(nBestHeight == 0)
            {
            nSubsidy = 1073333 * COIN; //Total premine coin
            }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "01april2017";
        CTransaction txNew;
        txNew.nTime = 1491052484;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1491052484;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 302808 : 302808;
        ...
        assert(block.hashMerkleRoot == uint256("0x1749b8c08ebe5530943d454fedc76d8d3f7ecfe244185a17f1f2501241129f6c"));
